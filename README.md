...
4. Acesse sua URL e inicie a instalação, é bem simples, basta preencher as informações no assistente de instalação **CâmaraAçailândia**.
...
## Autor
| [<img src="https://avatars.githubusercontent.com/RamonSilva20?s=115"><br><sub>CâmaraMunicipalAçailândia</sub>](https://www.cmacailandia.ma.gov.br/) |
| :---: |
